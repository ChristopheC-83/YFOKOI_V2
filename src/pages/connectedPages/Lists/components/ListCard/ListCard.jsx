...
export default function ListCard({ list, ownerDisplayName }) {
  const Icon = getIconById(list.icon);

  return (
    <div className="group relative w-full bg-card border border-border/90  rounded-2xl flex items-center  transition-all hover:scale-[1.02] shadow-2xl active:scale-[0.98] text-left cursor-pointer py-1">
      ...
      <div className="flex-1 flex gap-2 items-center">
        ...
        {ownerDisplayName && (
          <p className="pt-0.5 text-xs text-foreground/50 shrink-0 whitespace-nowrap">
            de {ownerDisplayName}
          </p>
        )}
      </div>
